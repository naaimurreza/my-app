        ...
        <>
            ...
            <div className='relative bg-linear-to-r from-sky-100/40 via-blue-50/40 to-emerald-100/40 backdrop-blur-sm border-y border-gray-200/30'>
                ...
                <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
                    <p className='text-xl md:text-3xl text-gray-800 dark:text-gray-100 text-center'>
                        {t("footer.tagline")}
                    </p>
                </div>
            </div>
            ...
            {/* Footer */}
            <footer className="relative bg-gray-50/30 dark:bg-gray-900/30 backdrop-blur-md">
                ...
                <div className="relative mx-auto w-full max-w-screen-xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
                        ...
                        <div className="lg:col-span-1">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed text-center md:text-left">
                        ...
                        {/* Navigation Links */}
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 dark:text-white">{t("footer.navigation")}</h2>
                            <ul className="space-y-3">
                                <li>
                                    <a href="./" className="text-gray-600 dark:text-gray-300 hover:text-sky-600 dark:hover:text-sky-400 transition-colors">
                                        {t("nav.home")}
                                    </a>
                                </li>
                                <li>
                                    <a href="./about" className="text-gray-600 dark:text-gray-300 hover:text-sky-600 dark:hover:text-sky-400 transition-colors">
                                        {t("nav.about")}
                                    </a>
                                </li>
                                <li>
                                    <a href="./services" className="text-gray-600 dark:text-gray-300 hover:text-sky-600 dark:hover:text-sky-400 transition-colors">
                                        {t("nav.services")}
                                    </a>
                                </li>
                                <li>
                                    <a href="./treatment" className="text-gray-600 dark:text-gray-300 hover:text-sky-600 dark:hover:text-sky-400 transition-colors">
                                        {t("nav.treatment")}
                                    </a>
                                </li>
                                <li>
                                    <a href="./articles" className="text-gray-600 dark:text-gray-300 hover:text-sky-600 dark:hover:text-sky-400 transition-colors">
                                        {t("nav.articles")}
                                    </a>
                                </li>
                                <li>
                                    <a href="./contact" className="text-gray-600 dark:text-gray-300 hover:text-sky-600 dark:hover:text-sky-400 transition-colors">
                                        {t("nav.contact")}
                                    </a>
                                </li>
                            </ul>
                        ...
                        {/* Contact Information */}
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider">{t("footer.contact")}</h2>
                            <ul className="space-y-3">
                                <li>
                                    <a
                                        ...
                                        className="text-gray-600 dark:text-gray-300 hover:text-sky-600 dark:hover:text-sky-400 transition-colors text-sm flex items-start gap-2"
                                    >
                                ...
                                <li>
                                    <a href="tel:+88058150414" className="text-gray-600 dark:text-gray-300 hover:text-sky-600 dark:hover:text-sky-400 transition-colors text-sm flex items-center gap-2">
                                        <span>📞</span>
                                        <span>+880 58150414</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="tel:+88029130270" className="text-gray-600 dark:text-gray-300 hover:text-sky-600 dark:hover:text-sky-400 transition-colors text-sm flex items-center gap-2">
                                        <span>📞</span>
                                        <span>+880 29130270</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="tel:+88029130269" className="text-gray-600 dark:text-gray-300 hover:text-sky-600 dark:hover:text-sky-400 transition-colors text-sm flex items-center gap-2">
                                        <span>📞</span>
                        ...
                        {/* Social Media */}
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 dark:text-white">{t("footer.followUs")}</h2>
                    ...
                    <div className="pt-8 border-t border-gray-200 dark:border-gray-700">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <span className="text-sm text-gray-600 dark:text-gray-300">
                                © {new Date().getFullYear()} <a href="./" className="text-sky-600 dark:text-sky-400 hover:text-sky-700 dark:hover:text-sky-300">Brain And Life Hospital</a>. {t("footer.copyright")}
                            </span>
