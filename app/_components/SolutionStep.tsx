    ...
    <div className='container mx-auto px-4 sm:px-6 lg:px-8 pt-80 lg:pt-20 md:pt-5 sm:pt-3'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10">
            <div className='py-6 bg-gray-50 rounded-md shadow-lg cursor-pointer hover:scale-105 duration-300 hover:shadow-xl p-4 hover:bg-blue-600 hover:text-white transition-all'>
                <img className='w-16 rounded-full shadow-lg mb-3' src="https://cdn-icons-png.flaticon.com/512/2785/2785482.png" alt="doctor icon" />
                <h1 className='font-semibold py-2 text-base sm:text-lg'>Share what you&apos;re going through</h1>
            ...
            <div className='py-6 bg-gray-50 rounded-md shadow-lg cursor-pointer hover:scale-105 duration-300 hover:shadow-xl p-4 hover:bg-blue-600 hover:text-white transition-all'>
              <img className='w-16 shadow-lg mb-3' src="https://cdn-icons-png.flaticon.com/512/10691/10691802.png" alt="doctor icon" />
                <h1 className='font-semibold py-2 text-base sm:text-lg'>Meet with a specialist</h1>
                <p className='py-3 text-sm sm:text-base'>
            ...
            <div className='py-6 bg-gray-50 rounded-md shadow-lg cursor-pointer hover:scale-105 duration-300 hover:shadow-xl p-4 hover:bg-blue-600 hover:text-white transition-all'>
              <img className='w-16 shadow-lg mb-3' src="https://cdn-icons-png.flaticon.com/512/16090/16090543.png" alt="doctor icon" />
                <h1 className='font-semibold py-2 text-base sm:text-lg'>Get your treatment plan</h1>
                <p className='py-3 text-sm sm:text-base'>
            ...
            <div className='py-6 bg-gray-50 rounded-md shadow-lg cursor-pointer hover:scale-105 duration-300 hover:shadow-xl p-4 hover:bg-blue-600 hover:text-white transition-all'>
              <img className='w-16 shadow-lg mb-3' src="https://cdn-icons-png.flaticon.com/512/9084/9084544.png" alt="doctor icon" />
                <h1 className='font-semibold py-2 text-base sm:text-lg'>Start care with ongoing support</h1>
                <p className='py-3 text-sm sm:text-base'>
