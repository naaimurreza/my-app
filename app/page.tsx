...
export const metadate: Metadata = {
  ...
  description:
    "Welcome to Brain And Life Hospital, your trusted destination for comprehensive mental health care. Our dedicated team of professionals is committed to providing compassionate, evidence-based treatment in a safe and supportive environment. Discover a path to healing and resilience with us.",
  keywords: [
    "Mental Hospital, Mental Health",
    "Psychiatric Care",
    "Therapy",
    "Counseling",
